...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(RSAKeyProperties keys, TokenBlacklistFilter tokenBlacklistFilter) {
        this.keys = keys;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .addFilterBefore(tokenBlacklistFilter, UsernamePasswordAuthenticationFilter.class) // Add custom filter before UsernamePasswordAuthenticationFilter

                // Configure authorization rules for different endpoints
                .authorizeHttpRequests(auth -> {
                    auth.requestMatchers(AUTH_ENDPOINT, TOKEN_ENDPOINT).permitAll(); // Permit access to /auth/** endpoints
